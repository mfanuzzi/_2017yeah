...
class Adafruit_DotStarMatrix_MF : public Adafruit_GFX, public Adafruit_DotStar {
 ...
 public:
  ...
  void
    ...
    setRemapFunction2(void (*fn)(int16_t &, int16_t &));
